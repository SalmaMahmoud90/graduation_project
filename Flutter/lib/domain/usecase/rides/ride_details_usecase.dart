...
@Injectable(as: IUseCase<BaseModel<RideDetailsModel>?, IdEntity>)
@Named('RideDetailsUseCase')
class RideDetailsUseCase
    implements IUseCase<BaseModel<RideDetailsModel>?, IdEntity> {
  final IRidesRepository _repository;
  RideDetailsUseCase(this._repository);

  @override
  Future<Either<AppException, BaseModel<RideDetailsModel>?>> call(
          IdEntity data) =>
      _repository.rideDetails(data);
}
