...
@Injectable(as: IUseCase<BaseModel<RidesListModel>?, RidesNoParamsEntity>)
@Named('MyRidesUseCase')
class MyRidesUseCase
    implements IUseCase<BaseModel<RidesListModel>?, RidesNoParamsEntity> {
  final IRidesRepository _repository;
  MyRidesUseCase(this._repository);
